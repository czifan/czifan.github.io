...
I am pursuing my Ph.D. at the Center for Data Science of Peking University, Beijing, under the guidance of [Professor Dong](http://faculty.bicmr.pku.edu.cn/~dongbin/). My main research direction is [multimodal medicine AI](https://github.com/czifan/Multimodal-Medicine-AI). [\[CV\]](https://github.com/czifan/czifan.github.io/blob/master/CZF_CV.pdf)
...
## Publications
-  ```co-first author``` ***Zifan Chen***, *Jie Zhao*, *Yanyan Li*, Yilin Li, Xinyu Nan, Huimin Liu, Xujiao Feng, Bin Dong, Lin Shen, Yang Chen, Li Zhang. [Predicting response to patients with gastric cancer via dynamic-aware model with longitudinal liquid biopsy data](https://link.springer.com/article/10.1007/s10120-025-01628-4). <span style="color:#3c7693">*Gastric Cancer (IF: 5.1)*</span>, 2025. [\[Supplementary Information\]](https://static-content.springer.com/esm/art%3A10.1007%2Fs10120-025-01628-4/MediaObjects/10120_2025_1628_MOESM1_ESM.docx)
